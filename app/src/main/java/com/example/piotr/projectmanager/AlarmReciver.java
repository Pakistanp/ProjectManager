...
import com.example.piotr.projectmanager.Activities.SettingsActivity;
import com.example.piotr.projectmanager.Database.UsersDatabaseHelper;

public class AlarmReciver extends BroadcastReceiver {

    public boolean getNotificationSwitch(Context context){
        PreferenceManager.setDefaultValues(context, R.xml.preferences, false);
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(context);
        Boolean switchPref = sharedPref.getBoolean(SettingsActivity.KEY_PREF_NOTIFICATIONS_SWITCH, false);
        return switchPref;
    }
    @Override
